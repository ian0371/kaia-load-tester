...
func (self *Account) TransferNewLegacyTxWithEth(c *ethclient.Client, endpoint string, to *Account, value *big.Int, input string, exePath string) (common.Hash, *big.Int, error) {
	self.mutex.Lock()
	defer self.mutex.Unlock()
